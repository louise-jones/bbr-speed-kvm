...
#	Version: 1.3.2
#	Author: minigeek
#	Blog: https://minigeek.blog.csdn.net
#=================================================

sh_ver="1.3.2"
github="raw.githubusercontent.com/louise-jones/bbr-speed-kvm/master"
...
startbbrmod_nanqinlang(){
	...
	if [[ "${release}" == "centos" ]]; then
		yum install -y make gcc
		mkdir bbrmod && cd bbrmod
		wget -N --no-check-certificate https://raw.githubusercontent.com/louise-jones/bbr-speed-kvm/master/bbr/centos/tcp_nanqinlang.c
		...
		mkdir bbrmod && cd bbrmod
		wget -N --no-check-certificate https://raw.githubusercontent.com/louise-jones/bbr-speed-kvm/master/bbr/tcp_nanqinlang.c
		echo "obj-m := tcp_nanqinlang.o" > Makefile
		make -C /lib/modules/$(uname -r)/build M=`pwd` modules CC=/usr/bin/gcc-4.9
...
echo && echo -e " TCP加速 一键安装管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  -- minigeek | minigeek.blog.csdn.net --
